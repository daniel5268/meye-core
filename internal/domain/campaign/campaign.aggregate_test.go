	...
	}{
		{
			...
			want: want{
				pj: campaign.CreatePJWithoutValidation(
					...
					defaultParams.BasicTalent,
					defaultParams.SpecialTalent,
					campaign.CreateBasicStatsWithoutValidation(
						campaign.CreatePhysicalWithoutValidation(0, 0, 0, 0),
						campaign.CreateMentalWithoutValidation(0, 0, 0, 0),
						campaign.CreateCoordinationWithoutValidation(0, 0, 0, 0),
						0,
					),
					campaign.CreateSpecialStatsWithoutValidation(
						campaign.CreatePhysicalSkillsWithoutValidation(0, 0),
						campaign.CreateMentalSkillsWithoutValidation(0, 0),
						campaign.CreateEnergySkillsWithoutValidation(0, 0),
						0,
					),
